...
final class Version20250324112022 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE post (id INT AUTO_INCREMENT NOT NULL, user_id_id INT NOT NULL, forum_id_id INT NOT NULL, name VARCHAR(100) NOT NULL, description VARCHAR(5000) NOT NULL, creation_date DATE NOT NULL, last_activity DATE NOT NULL, members INT NOT NULL, INDEX IDX_5A8A6C8D9D86650F (user_id_id), INDEX IDX_5A8A6C8D67303880 (forum_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user_questions (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, question VARCHAR(10) NOT NULL, answer VARCHAR(5000) NOT NULL, INDEX IDX_8A3CD931A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE post ADD CONSTRAINT FK_5A8A6C8D67303880 FOREIGN KEY (forum_id_id) REFERENCES forum (id)');
